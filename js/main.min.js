...
var _initSliderTrainer = require("./modules/sliders/init-slider-trainer");
var _initSliderFeedback = require("./modules/sliders/init-slider-feedback");
var _playVideo = require("./utils/play-video");
var _swoothScroll = require("./utils/swooth-scroll");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _swoothScroll.toSmoothScroll)();
  ...
  window.addEventListener('load', function () {
    ...
    (0, _initSliderTrainer.initTrainerSwiper)();
    (0, _initSliderFeedback.initFeedbackSwiper)();
...
},{"./modules/accordions/init-accordions":3,"./modules/form-validate/form":5,"./modules/modals/init-modals":11,"./modules/sliders/init-slider-feedback":13,"./modules/sliders/init-slider-trainer":14,"./modules/tabs/init-tabs":15,"./utils/ios-vh-fix":19,"./utils/play-video":20,"./utils/swooth-scroll":22}],2:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":17,"../../utils/scroll-lock":21}],13:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initFeedbackSwiper = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var initFeedbackSwiper = function initFeedbackSwiper() {
  return new _swiper.default('.feedback__swiper', {
    navigation: {
...
exports.initTrainerSwiper = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var initTrainerSwiper = function initTrainerSwiper() {
  return new _swiper.default('.trainer__swiper', {
    navigation: {
...
exports.toSmoothScroll = void 0;
function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
var toSmoothScroll = function toSmoothScroll() {
  var anchors = document.querySelectorAll('[data-smooth-scroll]');
...
exports.toSmoothScroll = toSmoothScroll;
